...
<h1>Customer Form</h1>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $connection->prepare("INSERT INTO Customer (Customer_Id,First_Name, Last_Name, Email, Phone_Number, Gender) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("bsssss", $Customer_Id, $First_Name, $Last_Name, $Email, $Phone_Number, $Gender);
        ...
        $Phone_Number = filter_var($_POST['phone'], FILTER_SANITIZE_NUMBER_INT); // Sanitize phone number
